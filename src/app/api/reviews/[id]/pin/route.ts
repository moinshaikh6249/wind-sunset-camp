...
export async function PUT(req: Request, { params }: { params: { id: string } }) {
  try {
    console.log('API HIT: /api/reviews/[id]/pin', params.id);
    ...
    console.error('REVIEW PIN ERROR:', error);
    return Response.json({ success: false, error: 'Failed to update review pin status' }, { status: 500 });
  }
}
